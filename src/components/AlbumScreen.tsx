    ...
    <div className="mx-auto max-w-[1000px]">
      ...
      <section className="grid grid-cols-1 overflow-hidden rounded-md border border-line bg-panel shadow-hard sm:grid-cols-[minmax(0,1fr)_210px]">
        <div className="p-[22px]">
          ...
          <div className="mb-3 mt-1.5 font-display font-black leading-none tracking-[-0.02em]">
            ...
            <span className="text-[18px] font-extrabold text-muted"> / {stats.total}</span>
          </div>
      ...
      {complete && (
        <div
          ...
          style={{ borderColor: '#c99a3a', background: 'linear-gradient(135deg,#f0cf8a,#c99a3a)', color: '#3a2a06' }}
        >
          ...
          <p className="mt-1 text-[13.5px]">Every Legendary, Iconic and Monumental sticker. A full house.</p>
        </div>
      )}
        ...
        return (
          <section key={tier} className="mt-8">
            <div className="mb-4 flex items-center gap-2.5 border-b-2 border-ink pb-2.5">
              <span className="inline-block h-2.5 w-2.5 rounded-full" style={{ background: meta.accent }} />
              <h3 className="font-display text-[19px] font-extrabold tracking-[-0.01em]">{meta.name}</h3>
              ...
              {afford && anyUncollected ? (
                <button
                  ...
                  onMouseEnter={(e) => (e.currentTarget.style.background = meta.accent)}
